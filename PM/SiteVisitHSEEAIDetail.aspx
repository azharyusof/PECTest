<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SiteVisitHSEEAIDetail.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="SiteVisitHSEEAIDetail" %>
...
<%--                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#EFEFEF" Wrap="false"><asp:Label ID="lblAwardSubCon" runat="server" CssClass="input-xxs" ForeColor="#000000"><b><a href="AwardSubContractorDetail.aspx?Id=<%= Request.QueryString["Id"] %>">AWARD <BR />TO THIRD<BR /> PARTY</a></b></asp:Label></asp:TableCell>                             --%>
                            ...
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblSiteVisit" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="SiteVisitHSELegalDetail.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">HSE</a></b></asp:Label></asp:TableCell>                             
...
<div class="panel-body">
        ...
        <div id="dvCode" runat="server">
            ...
            <div class="col-md-3">                
                ...
                <ul class="nav nav-tabs">
                    <li ID="tab2" runat="server"><a href='SiteVisitHSELegalDetail.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/user_half_information24.png" /> <asp:Label ID="lblTwo" runat="server" class="control-label input-xxs" Text="LEGAL REGISTER"></asp:Label></a></li>
                    <li ID="tab3" runat="server"><a href='SiteVisitHSEHIRARCDetail.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/document_text24.png" /> <asp:Label ID="lblThree" runat="server" class="control-label input-xxs" Text="HIRARC"></asp:Label></a></li>
                    ...
                    <li ID="tab5" runat="server"><a href='SiteVisitHSEPlanDetail.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/pdpa24.png" /> <asp:Label ID="lblFive" runat="server" class="control-label input-xxs" Text="HSE PLAN"></asp:Label></a></li>
                </ul>
    ...
    <div class="row">
        <div id="dvEIA" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE" data-toggle="modal" width="150">&nbsp;&nbsp;New EIA Report&nbsp;&nbsp;</button>
                <br />
    ...
    <asp:GridView ID="gvEIA" runat="server" Width="50%" AutoGenerateColumns="false" CssClass="table table-bordered table-striped input-xxs">
        ...
        <asp:TemplateField ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" CommandName="Delete" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this file?')" OnClick="DeleteEIA"/>
            </ItemTemplate>
        </asp:TemplateField>
        </Columns>
    ...
    <div class="row">
        <div id="dvDOE" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150">&nbsp;&nbsp;New Conditional Approval From DOE&nbsp;&nbsp;</button>
                <br />
    ...
    <asp:GridView ID="gvDOE" runat="server" Width="50%" AutoGenerateColumns="false" CssClass="table table-bordered table-striped input-xxs">
        ...
        <asp:TemplateField ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" CommandName="Delete" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this file?')" OnClick="DeleteDOE"/>
            </ItemTemplate>
        </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate>No Record Found</EmptyDataTemplate>  
    ...
    <div class="row">
        <div id="dvEMP" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalG" data-toggle="modal" width="150">&nbsp;&nbsp;New EMP (Environmental Management Plan)&nbsp;&nbsp;</button>
                <br />
    ...
    <asp:GridView ID="gvEMP" runat="server" Width="50%" AutoGenerateColumns="false" CssClass="table table-bordered table-striped input-xxs">
        ...
        <asp:TemplateField ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" CommandName="Delete" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this file?')" OnClick="DeleteEMP"/>
            </ItemTemplate>
        </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate>No Record Found</EmptyDataTemplate>  
    ...
    <div class="row">
        <div id="dvCAI" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalH" data-toggle="modal" width="150">&nbsp;&nbsp;New Contractor's Aspect & Impact Assessment&nbsp;&nbsp;</button>
                <br />
    ...
    <asp:GridView ID="gvCAI" runat="server" Width="50%" AutoGenerateColumns="false" CssClass="table table-bordered table-striped input-xxs">
        ...
        <asp:TemplateField ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" CommandName="Delete" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this file?')" OnClick="DeleteCAI"/>
            </ItemTemplate>
        </asp:TemplateField>
        </Columns>
        <EmptyDataTemplate>No Record Found</EmptyDataTemplate>  
    ...
    <div class="row">
        <div id="dvOPUS" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalI" data-toggle="modal" width="150">&nbsp;&nbsp;New Aspect / Impact Assessment&nbsp;&nbsp;</button>
                <br />
                ...
                <asp:GridView ID="gvOPUS" runat="server" Width="80%" AutoGenerateColumns="false" CssClass="table table-bordered table-striped input-xxs">
                    ...
                    <asp:TemplateField ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" CommandName="Delete" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this file?')" OnClick="DeleteAIA"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>No Record Found</EmptyDataTemplate>  
