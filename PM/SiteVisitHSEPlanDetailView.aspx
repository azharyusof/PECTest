<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SiteVisitHSEPlanDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="SiteVisitHSEPlanDetailView" %>
...
<div class="panel-body">
        ...
        <div id="dvCode" runat="server">
            ...
            <div class="col-md-3">                
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li ID="tab4" runat="server"><a href='SiteVisitHSEEAIDetailView.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/group_full_add24.png" /> <asp:Label ID="lblFour" runat="server" class="control-label input-xxs" Text="ENVIRONMENTAL ASPECT & IMPACT"></asp:Label></a></li>
    ...
    <div class="row">
        <div id="dvOPUS" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150" runat="server">&nbsp;&nbsp;New HSE Plan&nbsp;&nbsp;</button>
                <br />
