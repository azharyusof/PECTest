<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ProjectMonthlyUpdateHSERiskDetail.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ProjectMonthlyUpdateHSERiskDetail" %>
...
<div class="panel-body">
    ...
    <ul class="nav nav-tabs">
                    <li ID="Li1" runat="server"><a href='ProjectMonthlyUpdateDetail.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/document_sans_accept24.png" /> <asp:Label ID="Label21" runat="server" class="control-label input-xxs" Text="PROJECT STATUS"></asp:Label></a></li>
                    
<%--                    <li ID="Li2" runat="server"><a href='ProjectMonthlyUpdateCostSheetDetail.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/document_text24.png" /> <asp:Label ID="Label15" runat="server" class="control-label input-xxs" Text="COST SHEET"></asp:Label></a></li>--%>
    ...
    <div class="row">
        <div id="dvBeaconReport" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE" data-toggle="modal" width="150">&nbsp;&nbsp;New Risk Report&nbsp;&nbsp;</button>
                <br />
            ...
            <asp:TemplateField ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" CommandName="Delete" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this file?')" OnClick="DeleteBeaconReport"/>
                </ItemTemplate>
            </asp:TemplateField>
            </Columns>
        ...
        <div id="dvRiskAssessment" runat="server">
            ...
            <div class="col-md-12"> 
                ...
                <table runat="server" width="100%">
                    <tr>
                    <td align="left">
                        <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalC" data-toggle="modal" width="150">&nbsp;&nbsp;New Risk Assessment / Register&nbsp;&nbsp;</button>    
                    </td>
                    <td align="right">
