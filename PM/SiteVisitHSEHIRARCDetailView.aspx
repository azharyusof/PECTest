<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SiteVisitHSEHIRARCDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="SiteVisitHSEHIRARCDetailView" %>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="dvHIRARC" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE" data-toggle="modal" width="150" runat="server">&nbsp;&nbsp;New HIRARC Document&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div id="dvOPUS" runat="server">
            ...
            <div class="col-md-10"> 
            <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150" runat="server">&nbsp;&nbsp;New HIRARC Document&nbsp;&nbsp;</button>
                <br />
