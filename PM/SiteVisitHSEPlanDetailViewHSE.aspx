<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SiteVisitHSEPlanDetailViewHSE.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="SiteVisitHSEPlanDetailViewHSE" %>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="dvOPUS" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New HSE Plan&nbsp;&nbsp;</button>
                <br />
