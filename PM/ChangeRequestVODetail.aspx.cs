...
public partial class ChangeRequestVODetail : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String qs1 = "";
    ...
    protected void gvChangeRequestVO_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            //var hyperlink = e.Row.FindControl("lblReason") as HyperLink;

            //Label CRVOId = e.Row.FindControl("lblId") as Label;

            //if (hyperlink != null)
            //    hyperlink.NavigateUrl = "UpdateChangeRequestVO.aspx?Id=" + Request.QueryString["Id"] + "&Id1=" + CRVOId.Text;

            Label CRVOId = e.Row.FindControl("lblId") as Label;
            var updatelink = e.Row.FindControl("lblUpdate") as HyperLink;

            updatelink.NavigateUrl = "UpdateChangeRequestVO.aspx?Id=" + Request.QueryString["Id"] + "&Id1=" + CRVOId.Text;
