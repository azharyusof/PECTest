<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="AuditTrailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="AuditTrailView" %>
        ...
        <div id="dvCode" runat="server">
            ...
            <div class="col-md-3">                
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li ID="tab2" runat="server"><a href='AuditCSSView.aspx?Id=<%= Request.QueryString["Id"] %>'><img src="Img/Icon/group_full_add24.png" /> <asp:Label ID="lblTwo" runat="server" class="control-label input-xxs" Text="CLIENT SATISFACTION SURVEY"></asp:Label></a></li>
