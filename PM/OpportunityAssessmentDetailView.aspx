<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="OpportunityAssessmentDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="OpportunityAssessmentDetailView" %>
...
<div class="panel-body">
    ...
    <ul class="nav nav-tabs">
                    <li ID="tab1" runat="server"><a href='OpportunityGoNoGoDetailView.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/document_sans_accept24.png" /> <asp:Label ID="lblOne" runat="server" class="control-label input-xxs" Text="OPPORTUNITY INFO."></asp:Label></a></li>                    
