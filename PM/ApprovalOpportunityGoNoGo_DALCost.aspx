<%@ Page Title="" Language="C#" MasterPageFile="TMS_Email_MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalOpportunityGoNoGo_DALCost.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ApprovalOpportunityGoNoGo_DALCost" %>
...
<div class="panel-body">
    ...
    <img src="Img/images2.png"/> <asp:Label ID="Label14" runat="server" class="control-label input-xxs" Text="DAL Approval Status" Font-Bold="true"></asp:Label>
   ...
   <div class="row">
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1a" runat="server" class="control-label input-xxs" Font-Italic="true">&nbsp;&nbsp;&nbsp;&nbsp; If <b>Approved</b>, email notification will be sent to Project Manager for info.</asp:Label> 
            </div>
        </div>
    </div>
