<%@ Page Title="" Language="C#" MasterPageFile="TMS_Email_MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalFinancialPlanning.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ApprovalFinancialPlanning" %>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="dvApprover" runat="server">
            <div class="col-md-2">
                <label class="control-label input-xxs" data-toggle="tooltip" data-placement="right" data-container="body" data-html="true" title="Approver" for="lblApprover">Approved By </label>
            </div>            
            <div class="col-md-3">                  
                <asp:Label ID="lblApprover" runat="server" CssClass="input-xxs" Text="Finance"></asp:Label>       
            </div>
        </div>
    </div>
   ...
   <div class="row">
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1" runat="server" class="control-label input-xxs" Font-Italic="true"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Click on <b>Approve</b> or <b>Reject</b> button to approve or reject the Financial Planning module created in the Finance system.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1a" runat="server" class="control-label input-xxs" Font-Italic="true">&nbsp;&nbsp;&nbsp;&nbsp; When you have approved the Financial Planning module, email notification will be sent to Project Manager for info.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1b" runat="server" class="control-label input-xxs" Font-Italic="true">&nbsp;&nbsp;&nbsp;&nbsp; When you have rejected the Financial Planning module, email notification will be sent to Project Manager for info.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row" align="center">
        <asp:Button ID="btnApprove" runat="server" Text="Approve" CssClass="btn btn-success btn-xs input-xxs" Width="72" OnClientClick="return confirm('Are you sure you want to approve the Financial Planning module created in Finance system?');" OnClick="btnApprove_Click" />
        &nbsp;&nbsp;<asp:Button ID="btnNotApprove" runat="server" Text="Reject" CssClass="btn btn-danger btn-xs input-xxs" Width="60" OnClientClick="return confirm('Are you sure you want to reject the Financial Planning module created in Finance system?');" OnClick="btnNotApprove_Click" />
