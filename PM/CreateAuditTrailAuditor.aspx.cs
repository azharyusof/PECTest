...
public partial class CreateAuditTrailAuditor : System.Web.UI.Page
{
    DataRow row = null;
    DataRow row1 = null;
    DataRow rowCSS = null;
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        ...
        if (chckErr == true)
        {
            ...
            Response.Redirect("UpdateTrailAuditor.aspx?Id=" + Request.QueryString["Id"] + "&Id1=" + row["Id"].ToString());
        }        
    }

    protected void btnBack_Click(object sender, EventArgs e)
    {
        Response.Redirect("AuditTrailAuditor.aspx?Id=" + Request.QueryString["Id"]);
    }
