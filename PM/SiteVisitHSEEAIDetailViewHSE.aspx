<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SiteVisitHSEEAIDetailViewHSE.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="SiteVisitHSEEAIDetailViewHSE" %>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="dvEIA" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New EIA Report&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div id="dvDOE" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New Conditional Approval From DOE&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div id="dvEMP" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalG" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New EMP (Environmental Management Plan)&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div id="dvCAI" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalH" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New Contractor's Aspect & Impact Assessment&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div id="dvOPUS" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalI" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New Aspect / Impact Assessment&nbsp;&nbsp;</button>
                <br />
