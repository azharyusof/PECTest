...
public partial class CreateProjectCodeConversion : System.Web.UI.Page
{
    string queryString = "";
    DataRow row = null;
    String qs = "";
    ...
    protected void bindDetails()
    {
        ...
        qs = "";
        qs = qs + " SELECT              tblProjectRecord.*, tblMain.Code, tblMain.PreProjectCode, tblMain.ProjectCode, ";
        ...
        else
        {
            ...
            else
            {
                ...
                lblURLA3.Text = row["SupportingDoc"].ToString();
                hidURLA3.Value = "http://pectest.uemedgenta.com/PM/Upload/" + Request.QueryString["ID"] + "/SupportingDoc/" + row["SupportingDoc"].ToString() + "";
            }
            ...
            //Pre-Project Code
            fldPreCode.Text = row["PreProjectCode"].ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("CreateProjectCodeConversion.aspx?Id=" + Request.QueryString["Id"]);
    }
    ...
    protected void emailPM()
    {
        ...
        //---------------------------------------- send email -----------------------------------------        
        qs = "";
        qs = qs + " SELECT        tblMain.Id, tblMain.ClientId, tblMain.Description, tblMain.ProjectManager, tblMain.OperatingCompany, tblMain.ProjectCode, vwProjectRecordApproval.AppBy, ";
        ...
        qs = qs + "               INNER JOIN vwProjectRecordApproval ON tblMain.Id = vwProjectRecordApproval.DescriptionId ";
