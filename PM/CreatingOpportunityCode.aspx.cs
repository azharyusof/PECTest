...
public partial class CreatingOpportunityCode : System.Web.UI.Page
{
    string queryString = "";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("CreatingOpportunityCode.aspx?Id=" + Request.QueryString["Id"]);
    }
    ...
    protected void emailPM()
    {
        ...
        //---------------------------------------- send email -----------------------------------------        
        qs = "";
        qs = qs + " SELECT        tblMain.Id, tblMain.ClientId, tblMain.Description, tblMain.Code, tblMain.ProjectManager, tblMain.OperatingCompany, tblMain.Code, vwOpportunityGoNoGoApproval.AppBy, ";
