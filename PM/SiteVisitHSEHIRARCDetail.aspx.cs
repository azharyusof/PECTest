...
public partial class SiteVisitHSEHIRARCDetail : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String queryString = "";
    ...
    protected void DeleteHIRARC(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("DELETE FROM tblHIRARC WHERE ID=@ID", con);
    ...
    protected void DeleteOPUS(object sender, EventArgs e)
    {
        ImageButton imgDelete = (ImageButton)sender;
        con.Open();
