<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="EDMSOutgoing.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="EDMSOutgoing" %>
...
<div id="dvActive" runat="server">
        ...
        <div>
            ...
            <div class="col-md-6">                
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li ID="tab1" runat="server"><a href='EDMSIncoming.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/document_sans_accept24.png" /> <asp:Label ID="lblOne" runat="server" class="control-label input-xxs" Text="INCOMING"></asp:Label></a></li>

                    <li ID="tab2" runat="server" class="active"><a href="#tab1primary" data-toggle="tab"><img src="Img/Icon/document_text24.png" /> <asp:Label ID="lblTwo" runat="server" class="control-label input-xxs" Text="OUTGOING"></asp:Label></a></li>
    ...
    <div class="row">
        <div id="dvProjectDoc" runat="server">            
                ...
                <table runat="server" width="100%">
                    ...
                    <td align="left">
                        <div class="form-inline">
                            ...
                            <asp:DropDownList ID="fldOriginator" runat="server" CssClass="form-control input-xxs" Width="250px" AutoPostBack="True" OnSelectedIndexChanged="fldOriginator_SelectedIndexChanged"></asp:DropDownList>   
                        </div>
                    </td>
            ...
            <asp:GridView ID="gvProjectDoc" runat="server" Width="100%" AutoGenerateColumns="false" CssClass="table table-bordered table-striped input-xxs" AllowPaging="true" PageSize="50" OnRowDataBound="gvProjectDoc_RowDataBound" OnPageIndexChanging="gvMonthlyUpdate_OnPageIndexChanging">
            <Columns>                
            ...
            <asp:TemplateField HeaderText="" ItemStyle-Width="30" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>     
                            <asp:HyperLink ID="HyperLinkAll" ToolTip="Click here" runat="server" NavigateUrl='<%# "EDMSFile.aspx?C=" + Eval("PROJECT_CODE") + "&CC=" + Eval("COMPANY_CODE") + "&Y=" + Eval("YR") + "&M=Out&TN=" + Eval("FLD_OUT_SERIAL") %>' Target="_blank"><asp:Image style="cursor: pointer" src="Img/icon_pdf_small.gif" runat="server" id="img_all" /></asp:HyperLink>                        
                ...
                <asp:TemplateField HeaderText="Tracking No." ItemStyle-Width="70" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-Wrap="false" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>                       
                        <asp:Label ID="lblTNo" runat="server" Text='<%# Eval("FLD_OUT_SERIAL")%>' CssClass="input-xxs"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>                 
           ...
           <asp:TemplateField HeaderText="Date of Document" ItemStyle-Width="80" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" ItemStyle-Wrap="false" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                        <asp:Label ID="lblRcvdDt" runat="server" Text='<%# Eval("FLD_DOC_DATE").ToString() != "" ? Eval("FLD_DOC_DATE", "{0:dd-MMM-yyyy}") : "-"%>' CssClass="input-xxs"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="Out Reference No." ItemStyle-Width="80" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Subject" ItemStyle-Width="250" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Left" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Originator" ItemStyle-Width="130" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-VerticalAlign="Top">
                    <ItemTemplate>
                        <asp:Label ID="lblOriginator" runat="server" Text='<%# Eval("ORIGINATOR").ToString() != "" ? Eval("ORIGINATOR").ToString().ToUpper().HighlightKeyWords(search_Word, "yellow", false) : "-"%>' CssClass="input-xxs"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
