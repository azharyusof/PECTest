 <%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ChangeRequestVODetail.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ChangeRequestVODetail" %>
...
<%--                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#EFEFEF" Wrap="false"><asp:Label ID="lblAwardSubCon" runat="server" CssClass="input-xxs" ForeColor="#000000"><b><a href="AwardSubContractorDetail.aspx?Id=<%= Request.QueryString["Id"] %>">AWARD <BR />TO THIRD<BR /> PARTY</a></b></asp:Label></asp:TableCell>                             --%>
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblChangeRequest" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="ChangeRequestVODetail.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">CHANGE MANAGEMENT</a></b></asp:Label></asp:TableCell> 
                            ...
                            <asp:GridView ID="GridViewAttachment" runat="server" AutoGenerateColumns="false" Width="100%" ShowHeader="false" GridLines="None">
                                <Columns>
                                    <asp:TemplateField HeaderText="" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Left">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "http://pectest.uemedgenta.com/PM/Upload/" + Request.QueryString["ID"] + "/" + Eval("ChangeRequestId") + "/" + Eval("Folder") + "/" + Eval("FileName") + "" %>' Target="_blank"><asp:Label ID="lblRemark" runat="server" Text= '<%# Eval("FileName").ToString()%>' ></asp:Label></asp:HyperLink>                                            
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>                            
                         </asp:GridView>
