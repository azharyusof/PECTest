<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ProjectInitiationDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ProjectInitiationDetailView" %>
...
<script src="../Scripts/jquery.MultiFile.js" type="text/javascript"></script>
    ...
    <asp:Table ID="tblMenu" runat="server" Width="100%" CssClass="table table-bordered input-xxs" >
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" >                        
                            ...
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblProjectInitiation" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="ProjectInitiationDetailView.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">PROJECT INITIATION</a></b></asp:Label></asp:TableCell>                             
...
<div id="dvActive" runat="server">
    ...
    <div class="row">
        <div id="dvAgreement" runat="server">
            ...
            <div class="col-md-10"> 
                <button id="btnNewSA" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150">&nbsp;&nbsp;New Supplement Agreement&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewPEP" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE1" data-toggle="modal" width="150">&nbsp;&nbsp;New Project Execution Plan&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewPQP" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE2" data-toggle="modal" width="150">&nbsp;&nbsp;New PQP&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewPSP" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE9" data-toggle="modal" width="150">&nbsp;&nbsp;New PSP&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewLR" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE3" data-toggle="modal" width="150">&nbsp;&nbsp;New Legal Register&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewHIRARC" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE4" data-toggle="modal" width="150">&nbsp;&nbsp;New HIRARC&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewEAI" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE5" data-toggle="modal" width="150">&nbsp;&nbsp;New Environmental Aspect & Impact&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewHSEP" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE6" data-toggle="modal" width="150">&nbsp;&nbsp;New HSE Plan&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div id="dvProjectDoc" runat="server">
            ...
            <div class="col-md-10"> 
                <button id="btnNewPD" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE" data-toggle="modal" width="150">&nbsp;&nbsp;New Project Document&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewOC" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE7" data-toggle="modal" width="150">&nbsp;&nbsp;New Organization Chart&nbsp;&nbsp;</button>
                <br />
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-10">                
                <button id="btnNewMS" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE8" data-toggle="modal" width="150">&nbsp;&nbsp;New Manning Schedule&nbsp;&nbsp;</button>
                <br />
        ...
        <div id="dvRiskAssessment" runat="server">
            ...
            <div class="col-md-12"> 
                ...
                <table runat="server" width="100%">
                    <tr>
                    <td align="left">
                        <button id="btnNewRA" runat="server" class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalC" data-toggle="modal" width="150">&nbsp;&nbsp;New Risk Assessment&nbsp;&nbsp;</button>    
                    </td>
                    <td align="right">
