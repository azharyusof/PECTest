...
public partial class ProjectMonthlyUpdateHSERiskDetail : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String queryString = "";
    ...
    protected void DeleteBeaconReport(object sender, EventArgs e)
    {
        ImageButton imgDelete = (ImageButton)sender;
        con.Open();

        SqlCommand cmd = new SqlCommand("DELETE FROM tblBeaconReport WHERE ID=@ID", con);
