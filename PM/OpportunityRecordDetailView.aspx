<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="OpportunityRecordDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="OpportunityRecordDetailView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ChildContent2" Runat="Server">
    ...
    <asp:Table ID="tblMenu" runat="server" Width="100%" CssClass="table table-bordered input-xxs" >
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" >                        
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblOpportunityRecord" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="OpportunityRecordDetailView.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">OPPORTUNITY RECORD</a></b></asp:Label></asp:TableCell>
