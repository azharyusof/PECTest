<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ProposalEvaluationDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ProposalEvaluationDetailView" %>
...
<script src="../Scripts/jquery.MultiFile.js" type="text/javascript"></script>
    ...
    <asp:Table ID="tblMenu" runat="server" Width="100%" CssClass="table table-bordered input-xxs" >
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" >                        
                            ...
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblProposalEvaluation" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="ProposalEvaluationDetailView.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">PROPOSAL EVALUATION / SUBMISSION</a></b></asp:Label></asp:TableCell>
