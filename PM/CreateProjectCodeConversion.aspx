<%@ Page Title="" Language="C#" MasterPageFile="TMS_Email_MasterPage.master" AutoEventWireup="true" CodeFile="CreateProjectCodeConversion.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="CreateProjectCodeConversion" %>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="Div1" runat="server">
            <div class="col-md-2">
                <label class="control-label input-xxs" data-toggle="tooltip" data-placement="right" data-container="body" data-html="true" title="Project Code" for="fldCode">Pre-Project Code <font color="Red">*</font></label>
            </div>            
            <div class="col-md-3">  
                <asp:Label ID="fldPreCode" runat="server" class="control-label input-xxs"></asp:Label>
            </div>
        </div>
    </div>
