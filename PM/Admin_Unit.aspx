<%@ Page Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="Admin_Unit.aspx.cs" Inherits="PM_Admin_Unit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent1" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ChildContent2" Runat="Server">

<div class="panel-heading">Administration - Operating Unit</div>
...
<div class="panel-body"> <!--Start Panel Body-->
    ...
    <!--Start here New Operating Unit button-->
 
    <button type="button" class="btn btn-warning btn-xs input-xxs"  data-toggle="modal" data-target="#myModal" onclick="javascript: return false;" width="150">&nbsp;&nbsp;New Operating Unit&nbsp;&nbsp;</button> 

    <!--End here New Operating Unit button-->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="Img/images2.png"/> <asp:Label ID="lblProject" runat="server" class="control-label input-xxs" Text="New Operating Unit" Font-Bold="true"></asp:Label>&nbsp;&nbsp;
                </div>
                <div class="modal-body">
                   ...
                   <br />
                    <div class="row">
                        <div id="dvOperatingUnit" runat="server">
                            <div class="col-md-3">
                                <label class="control-label input-xxs" data-toggle="tooltip" data-placement="right" data-container="body" data-html="true" title="Operating Unit" for="fldOperatingUnit">Operating Unit <font color="Red">*</font></label>
                            </div>            
                            <div class="col-md-4">  
                                 <asp:TextBox ID="fldOperatingUnit" runat="server" CssClass="form-control input-xxs" Width="320px" PlaceHolder="(Operating Unit)" MaxLength="850"></asp:TextBox> 
                            </div>
                        </div>
                    </div>
                     <br />
    ...
    <asp:GridView ID="gvOperatingUnit" runat="server" CssClass="table table-bordered table-striped input-xxs" AutoGenerateColumns="false" DataKeyNames="Id" ShowHeaderWhenEmpty="True" Width="50%" onrowediting="EditOperatingUnit" onrowupdating="UpdateOperatingUnit"  onrowcancelingedit="CancelEdit">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Operating Unit" ItemStyle-Width="80%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-VerticalAlign="Top" FooterStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:Label ID="lblOperatingUnit" runat="server" Text='<%# Eval("OperatingUnit").ToString() != "" ? Eval("OperatingUnit").ToString() : "-"%>' CssClass="input-xxs"></asp:Label>                    
                    </ItemTemplate>

                    <EditItemTemplate>
                        <asp:TextBox ID="fldOperatingUnit" runat="server" Text='<%# Eval("OperatingUnit")%>' Width="250" CssClass="form-control input-xxs"></asp:TextBox>
                    </EditItemTemplate> 

                    <FooterTemplate>   
                        <asp:TextBox ID="fldOperatingUnit" runat="server" Width="250" CssClass="form-control input-xxs"></asp:TextBox>
                    </FooterTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField ItemStyle-Width="5%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" runat="server" CommandName ="Delete" CommandArgument = '<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this Operating Unit?')"  OnClick = "DeleteRow"></asp:ImageButton>
                    </ItemTemplate>
                </asp:TemplateField>
