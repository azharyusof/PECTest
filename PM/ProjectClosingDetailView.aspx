<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ProjectClosingDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ProjectClosingDetailView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ChildContent2" Runat="Server">
    ...
    <asp:Table ID="tblMenu" runat="server" Width="100%" CssClass="table table-bordered input-xxs" >
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" >                        
                            ...
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblProjectClosing" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="ProjectClosingDetailView.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">PROJECT CLOSE</a></b></asp:Label></asp:TableCell> 
                        </asp:TableRow>
    </asp:Table>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="dvCerts" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New Relevant Certs&nbsp;&nbsp;</button>
                <br />
                                                    ...
                                                    <div class="col-md-3"> 
                                                        <div id="dvA1" runat="server" class="form-group">
                                                            <div class="input-group input-group-xs">
                                                                ...
                                                                <span class="input-group-btn"><asp:Button ID="btnCancelA1" runat="server" Text="Cancel" CssClass="btn btn-danger btn-xs" Enabled="false"/></span>
                                                                <span class="input-group-btn"><asp:Button ID="btnUpA1" runat="server" Text="Upload" CssClass="btn btn-success btn-xs" Enabled="false"/></span>
                                                            </div>                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-3"> 
                                                        <div id="dvA2" runat="server" class="form-group">
                                                            <div class="input-group input-group-xs">
                                                                ...
                                                                <span class="input-group-btn"><asp:Button ID="btnCancelA2" runat="server" Text="Cancel" CssClass="btn btn-danger btn-xs" Enabled="false"/></span>
                                                                <span class="input-group-btn"><asp:Button ID="btnUpA2" runat="server" Text="Upload" CssClass="btn btn-success btn-xs" Enabled="false"/></span>
                                                            </div>                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-3"> 
                                                        <div id="dvA4" runat="server" class="form-group">
                                                            <div class="input-group input-group-xs">
                                                                ...
                                                                <span class="input-group-btn"><asp:Button ID="btnCancelA4" runat="server" Text="Cancel" CssClass="btn btn-danger btn-xs" Enabled="false"/></span>
                                                                <span class="input-group-btn"><asp:Button ID="btnUpA4" runat="server" Text="Upload" CssClass="btn btn-success btn-xs" Enabled="false"/></span>
                                                            </div>                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-3"> 
                                                        <div id="dvA5" runat="server" class="form-group">
                                                            <div class="input-group input-group-xs">
                                                                ...
                                                                <span class="input-group-btn"><asp:Button ID="btnCancelA5" runat="server" Text="Cancel" CssClass="btn btn-danger btn-xs" Enabled="false"/></span>
                                                                <span class="input-group-btn"><asp:Button ID="btnUpA5" runat="server" Text="Upload" CssClass="btn btn-success btn-xs" Enabled="false"/></span>
                                                            </div>                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-3"> 
                                                        <div id="dvA6" runat="server" class="form-group">
                                                            <div class="input-group input-group-xs">
                                                                ...
                                                                <span class="input-group-btn"><asp:Button ID="btnCancelA6" runat="server" Text="Cancel" CssClass="btn btn-danger btn-xs" Enabled="false"/></span>
                                                                <span class="input-group-btn"><asp:Button ID="btnUpA6" runat="server" Text="Upload" CssClass="btn btn-success btn-xs" Enabled="false"/></span>
                                                            </div>                                            
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-3"> 
                                                        <div id="dvA7" runat="server" class="form-group">
                                                            <div class="input-group input-group-xs">
                                                                ...
                                                                <span class="input-group-btn"><asp:Button ID="btnCancelA7" runat="server" Text="Cancel" CssClass="btn btn-danger btn-xs" Enabled="false"/></span>
                                                                <span class="input-group-btn"><asp:Button ID="btnUpA7" runat="server" Text="Upload" CssClass="btn btn-success btn-xs" Enabled="false"/></span>
                                                            </div>                                            
                                                        </div>
                                                    </div>
                                                </div>
