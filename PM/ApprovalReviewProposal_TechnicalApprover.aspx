<%@ Page Title="" Language="C#" MasterPageFile="TMS_Email_MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalReviewProposal_TechnicalApprover.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ApprovalReviewProposal_TechnicalApprover" %>
...
<div class="panel-heading">PROPOSAL EVALUATION / SUBMISSION - TECHNICAL APPROVAL</div>
<div class="panel-body">
    ...
    <img src="Img/images2.png"/> <asp:Label ID="Label3" runat="server" class="control-label input-xxs" Text="Signed Proposal" Font-Bold="true"></asp:Label>
    ...
    <img src="Img/images2.png"/> <asp:Label ID="Label12" runat="server" class="control-label input-xxs" Text="Technical Approval Status" Font-Bold="true"></asp:Label>
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-3">                  
                <asp:Label ID="lblTechnicalApprover" runat="server" Text='None' CssClass="input-xxs" ></asp:Label>       
            </div>
        </div>
    </div>
