...
public partial class CreatingProjectCode : System.Web.UI.Page
{
    string queryString = "";
    DataRow row = null;
    String qs = "";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("CreatingProjectCode.aspx?Id=" + Request.QueryString["Id"]);
    }


    protected void btnListing_Click(object sender, EventArgs e)
    {
        Response.Redirect("ProjectListingFin.aspx");
    }
    ...
    protected void emailPM()
    {
        ...
        //---------------------------------------- send email -----------------------------------------        
        qs = "";
        qs = qs + " SELECT        tblMain.Id, tblMain.ClientId, tblMain.Description, tblMain.ProjectManager, tblMain.OperatingCompany, tblMain.PreProjectCode, tblMain.ProjectCode, vwProjectRecordApproval.AppBy, ";
        ...
        {
            code = row["PreProjectCode"].ToString();
        }
        ...
        string htmlText = "<HTML><BODY BGCOLOR=#FFFFE6 STYLE=FONT:TAHOMA,8PT;>"
                            ...
                            + "<B>Project Code : </B>" + code + "<BR><BR><BR>"
