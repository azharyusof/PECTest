<%@ Page Title="" Language="C#" MasterPageFile="TMS_Email_MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalReviewProposal_LegalApprover.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ApprovalReviewProposal_LegalApprover" %>
...
<div class="panel-heading">PROPOSAL EVALUATION / SUBMISSION - LEGAL / RISK APPROVAL</div>
<div class="panel-body">
    ...
    <img src="Img/images2.png"/> <asp:Label ID="Label12" runat="server" class="control-label input-xxs" Text="Legal / Risk Approval Status" Font-Bold="true"></asp:Label>
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-3">                  
                <asp:Label ID="lblLegalApprover" runat="server" Text='None' CssClass="input-xxs" ></asp:Label>       
            </div>
        </div>
    </div>
