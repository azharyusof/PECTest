...
public partial class SiteVisitHSEEAIDetail : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String queryString = "";
    ...
    protected void DeleteEIA(object sender, EventArgs e)
    {
        ImageButton imgDelete = (ImageButton)sender;
        con.Open();

        SqlCommand cmd = new SqlCommand("DELETE FROM tblEnvAspectImpact WHERE ID=@ID", con);
    ...
    protected void DeleteDOE(object sender, EventArgs e)
    {
        ImageButton imgDelete = (ImageButton)sender;
        con.Open();
    ...
    protected void DeleteCAI(object sender, EventArgs e)
    {
        ImageButton imgDelete = (ImageButton)sender;
        con.Open();
    ...
    protected void DeleteAIA(object sender, EventArgs e)
    {
        ImageButton imgDelete = (ImageButton)sender;
        con.Open();
