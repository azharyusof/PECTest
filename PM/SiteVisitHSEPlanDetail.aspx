<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SiteVisitHSEPlanDetail.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="SiteVisitHSEPlanDetail" %>
...
<div class="panel-body">
        ...
        <div id="dvCode" runat="server">
            ...
            <div class="col-md-3">                
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li ID="tab4" runat="server"><a href='SiteVisitHSEEAIDetail.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/group_full_add24.png" /> <asp:Label ID="lblFour" runat="server" class="control-label input-xxs" Text="ENVIRONMENTAL ASPECT & IMPACT"></asp:Label></a></li>
                    <li ID="tab5" runat="server" class="active"><a href="#tab1primary" data-toggle="tab"><img src="Img/Icon/pdpa24.png" /> <asp:Label ID="lblFive" runat="server" class="control-label input-xxs" Text="HSE PLAN"></asp:Label></a></li>
                </ul>
        ...
        <div id="dvOPUS" runat="server">
            <div class="col-md-2">
                <div class="form-inline">
                    <label class="control-label input-xxs" data-toggle="tooltip" data-placement="right" data-container="body" data-html="true" title="HSE Plan" for="fldOPUS">HSE Plan </label>
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="img/dload.png" ToolTip="Download template" OnClientClick="window.open('HSE/General 2018 (compliance check) BLANK COPY.doc')"></asp:ImageButton>
                    <br />
                    <asp:Label ID="Label3" runat="server" class="control-label input-xxs"><em>(Standard HSE plan for OPUS)</em></asp:Label>
                    
                </div>
            </div>
            
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150">&nbsp;&nbsp;New HSE Plan&nbsp;&nbsp;</button>
                <br />
    ...
    <asp:TemplateField HeaderText="File Name" HeaderStyle-Width="50%" ItemStyle-Width="50%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
        <ItemTemplate>
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "http://pectest.uemedgenta.com/PM/Upload/" + Request.QueryString["ID"] + "/HSEPlan/" + Eval("FileName") + "" %>' Target="_blank"><%# Eval("FileName").ToString()%></asp:HyperLink>            
        </ItemTemplate>
    </asp:TemplateField>
    ...
    <asp:TemplateField ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
        <ItemTemplate>
            <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" CommandName="Delete" runat="server" CommandArgument='<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this file?')" OnClick="DeleteLegal"/>
        </ItemTemplate>
    </asp:TemplateField>
    </Columns>
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1" runat="server" class="control-label input-xxs" Font-Italic="true"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Click on <b>New HSE Plan</b> button to upload HSE plan.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote2" runat="server" class="control-label input-xxs" Font-Italic="true"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Click on &nbsp;<img src="Img/dload.png"/>&nbsp; to download new template for HSE plan.</asp:Label> 
            </div>
        </div>
    </div>
...
<div class="modal fade" id="myModalF" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <img src="Img/images2.png"/> <asp:Label ID="lblLegal" runat="server" class="control-label input-xxs" Text="New HSE Plan" Font-Bold="true"></asp:Label>
        </div>
