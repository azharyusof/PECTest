...
public partial class ApprovalReviewProposal_LegalApprover : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String qs1 = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            qs = "";
            qs = qs + " SELECT        LegalAppDate, LegalNotAppDate, LegalAppStatus, LegalAppComment ";
            ...
            else
            {
                ...
                object dtA = row["LegalAppDate"];
                object dtNA = row["LegalNotAppDate"];
    ...
    protected void bindDetails()
    {
        ...
        qs = qs + "               StaffLogin.StaffName AS LegalApproverName ";
        qs = qs + " FROM          tblProposalEvaluation ";
        ...
        qs = qs + " INNER JOIN    StaffLogin ON tblProposalEvaluation.LegalApprover = StaffLogin.StaffNo COLLATE Latin1_General_CI_AI ";
        ...
        else
        {
            ...
            //...................................Legal / Risk Approval Status...................................
            
            //Approver - Name
            fldLegalApprover.Text = row["LegalApprover"].ToString();
            lblLegalApprover.Text = row["LegalApproverName"].ToString();

            //Date Approved
            object dt8 = row["LegalAppDate"];
            if (dt8 == DBNull.Value)
            {
            ...
            { lblDtApproved.Text = Convert.ToDateTime(row["LegalAppDate"].ToString()).ToString("dd-MMM-yyyy hh:mm:ss tt"); }

            //Date Rejected
            object dt9 = row["LegalNotAppDate"];
            if (dt9 == DBNull.Value)
            {
            ...
            { lblDtReject.Text = Convert.ToDateTime(row["LegalNotAppDate"].ToString()).ToString("dd-MMM-yyyy hh:mm:ss tt"); }

            //Justification
            fldJustification.Text = row["LegalAppComment"].ToString();
            //...................................end of Legal / Risk Approval Status...................................
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmdR = new SqlCommand("UPDATE tblProposalEvaluation SET "
                + "LegalAppStatus = 'Approved', "
                + "LegalAppDate = '" + now.ToString("dd-MMM-yyyy hh:mm:ss tt") + "' "
        ...
        objeto_mail.Subject = "Approved : Request for Legal / Risk Approval for '" + row["Description"].ToString() + "'";

        string htmlText = "<HTML><BODY BGCOLOR=#FFFFE6 STYLE=FONT:TAHOMA,8PT;>"
                            + "Hi " + row["PMName"].ToString() + ",<BR><BR><BR>"

                            + "Your final proposal for the following opportunity has been <B>APPROVED</B> by Legal / Risk team. Please get the signature from DAL person and upload the signed proposal into the system.<BR><BR><BR>"
        ...
        Response.Redirect("ApprovalReviewProposal_LegalApprover.aspx?Id=" + Request.QueryString["Id"]);
    }
    ...
    protected void btnNotApprove_Click(object sender, EventArgs e)
    {
        ...
        if (chckErr == true)
        {
            ...
            SqlCommand cmdNR = new SqlCommand("UPDATE tblProposalEvaluation SET "
                    + "LegalAppStatus = 'Rejected', "
                    + "LegalNotAppDate = '" + now.ToString("dd-MMM-yyyy hh:mm:ss tt") + "', "
                    + "LegalAppComment = @pJustification "
                    + "WHERE DescriptionId = '" + Request.QueryString["Id"] + "'", con);
            ...
            qs = "";
            qs = qs + " SELECT        tblMain.Id, tblMain.ClientId, tblMain.Description, tblMain.Code, tblMain.ProjectManager, tblMain.OperatingCompany, tblMain.OperatingUnit, tblMain.CreatedBy, ";
            qs = qs + "               tblProposalEvaluation.ProposalForReview, tblProposalEvaluation.ClosingDate, tblProposalEvaluation.ReviewedByDate, tblProposalEvaluation.LegalApprover, tblProposalEvaluation.LegalAppComment, ";
            qs = qs + "               tblClient.ClientName AS ClientName, ";
            qs = qs + "               StaffLogin.StaffName AS PMName, StaffLogin.EmailId AS PMEmail, ";
            ...
            objeto_mail.Subject = "Rejected : Request for Legal / Risk Approval for '" + row["Description"].ToString() + "'";
            ...
            string htmlText = "<HTML><BODY BGCOLOR=#FFECEC STYLE=FONT:TAHOMA,8PT;>"
                                ...
                                + "<B>Comments : </B>" + row["LegalAppComment"].ToString() + "<BR><BR><BR>"
    ...
    protected void checkStatus()
    {
        ...
        //qs = "";
        //qs = qs + " SELECT        TechnicalStatus, CommercialStatus, LegalStatus ";
        //qs = qs + " FROM          vwProposalEvaluationPreSubmitStatus ";
        //qs = qs + " WHERE         (TechnicalStatus = 'Approved' OR TechnicalStatus = 'N/A') ";
        //qs = qs + " AND           (CommercialStatus = 'Approved' OR CommercialStatus = 'N/A') ";
