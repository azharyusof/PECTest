<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="OpportunityGoNoGoDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="OpportunityGoNoGoDetailView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ChildContent2" Runat="Server">
    ...
    <asp:Table ID="tblMenu" runat="server" Width="100%" CssClass="table table-bordered input-xxs" >
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" >                        
                            ...
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblOpportunityGo" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="OpportunityGoNoGoDetailView.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">OPPORTUNITY GO / NO-GO</a></b></asp:Label></asp:TableCell>
...
<div class="panel-body">
    ...
    <asp:Table ID="tblHeader" runat="server" Width="100%" CssClass="input-sm">
                <asp:TableRow>
                    <asp:TableCell><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="img/info.jpg" ToolTip="Workflow" OnClientClick="window.open('Workflow/Workflow_Opportunity_GoNoGo.pdf')"></asp:ImageButton></asp:TableCell>
...
<div id="dvActive" runat="server">
    ...
    <ul class="nav nav-tabs">
                    <li ID="tab1" runat="server" class="active"><a href="#tab1primary" data-toggle="tab"><img src="Img/Icon/document_sans_accept24.png" /> <asp:Label ID="lblOne" runat="server" class="control-label input-xxs" Text="OPPORTUNITY INFO."></asp:Label></a></li>
                    <li ID="tab2" runat="server"><a href='OpportunityAssessmentDetailView.aspx?Id=<%=Request.QueryString["Id"]%>' ><img src="Img/Icon/document_text24.png" /> <asp:Label ID="lblTwo" runat="server" class="control-label input-xxs" Text="OPPORTUNITY ASSESSMENT"></asp:Label></a></li>                    
                </ul>
    ...
    <img src="Img/images2.png"/> <asp:Label ID="Label7" runat="server" class="control-label input-xxs" Text="Evaluation" Font-Bold="true"></asp:Label>
    ...
    <div class="row">
        <div id="dvEvaluationPerson" runat="server">
            <div class="col-md-2">
                ...
                <br />
                    <asp:Label ID="Label8" runat="server" class="control-label input-xxs"><em>[Min. of 1 representative from Technical, BD, BE, Bid Manager & DAL Approver]</em></asp:Label>
            </div>
    ...
    <asp:GridView ID="gvEvaluationPerson" runat="server" Width="70%" AutoGenerateColumns="false" CssClass="table table-bordered table-striped input-xxs" onrowediting="EditEvaluation" onrowupdating="UpdateEvaluation" onrowcancelingedit="CancelEvaluationEdit" OnRowDataBound="gvEvaluationPerson_RowDataBound">
    <Columns>                
    <asp:TemplateField HeaderText="#" HeaderStyle-Width="5%" ItemStyle-Width="5%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
            <asp:Label ID="lblNoUp" runat="server" Text='<%# Container.DataItemIndex + 1 %>' CssClass="input-xxs"></asp:Label>
    ...
    <div class="row">
        <div id="dvDecision" runat="server">
            ...
            <div class="col-md-3">  
                <div class="form-inline">
                    <asp:DropDownList ID="fldDecision" runat="server" CssClass="form-control input-xxs" Width="150px"></asp:DropDownList> 
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="dvDALApprovalCost" runat="server">
            ...
            <asp:Table ID="tblDALApprovalCost" runat="server" Width="60%" CssClass="table table-bordered input-xxs">
                        ...
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" BackColor="#808080">                        
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" ColumnSpan="2" Width="50%"><asp:Label ID="lblDALReviewerCost" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b>DAL Approval</b></asp:Label></asp:TableCell>                           
                        </asp:TableRow>
                        ...
                        <asp:TableRow>    
                            <asp:TableCell HorizontalAlign="Left" BackColor="White">
                                ...
                                <br /><asp:Label ID="lblDALA2Cost" runat="server" class="control-label input-xxs"><b>Date :</b></asp:Label> 
                                <br /><asp:Label ID="lblDALA3Cost" runat="server" class="control-label input-xxs"><b>Status :</b></asp:Label> 
                                <br /><asp:Label ID="lblDALA4Cost" runat="server" class="control-label input-xxs"><b>Comment :</b></asp:Label> 
                            </asp:TableCell> 
                            <asp:TableCell HorizontalAlign="Left" BackColor="White">
                                ...
                                <br /><asp:Label ID="lblDAL_ApprovedStatusCost" runat="server" class="control-label input-xxs" Font-Italic="true" ForeColor="#666666"></asp:Label>
                                <br /><asp:Label ID="lblDAL_ApprovedCommentCost" runat="server" class="control-label input-xxs" Font-Italic="true" ForeColor="#666666"></asp:Label>
                                                 
                                <br /><asp:Label ID="lvlDALBODCost" runat="server" class="control-label input-xxs" Font-Italic="true" ForeColor="Red" Visible="false">Please submit to BOD or MD/CEO for approval.<br /></asp:Label>
    ...
    <div class="row">
        <div id="dvDALApproval" runat="server">
            ...
            <asp:Table ID="tblDALApproval" runat="server" Width="60%" CssClass="table table-bordered input-xxs">
                        ...
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" BackColor="#808080">                        
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" ColumnSpan="2" Width="50%"><asp:Label ID="lblDALReviewer" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b>DAL Approval</b></asp:Label></asp:TableCell>                           
                        </asp:TableRow>
...
<!-------------------------------------------- End of active screen -------------------------------------------->    
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <img src="Img/images2.png"/> <asp:Label ID="lblProject" runat="server" class="control-label input-xxs" Text="New Project Risk" Font-Bold="true"></asp:Label>
        </div>
        <div class="modal-body">
            ...
            <div class="row">
                <div id="dvRisk" runat="server">
                    <div class="col-md-3">
                        <label class="control-label input-xxs" data-toggle="tooltip" data-placement="right" data-container="body" data-html="true" title="Risk" for="fldRisk">Risk Description <br />(Include Cost & Impact of Risk) <font color="Red">*</font></label>
                    </div>            
                    <div class="col-md-4">  
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <img src="Img/images2.png"/> <asp:Label ID="lblContract" runat="server" class="control-label input-xxs" Text="New Contract Risk" Font-Bold="true"></asp:Label>
        </div>
        <div class="modal-body">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <img src="Img/images2.png"/> <asp:Label ID="lblEvaluation" runat="server" class="control-label input-xxs" Text="New Evaluation Person / Committee" Font-Bold="true"></asp:Label>
        </div>
        <div class="modal-body">
