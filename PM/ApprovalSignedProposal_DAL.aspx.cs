...
public partial class ApprovalSignedProposal_DAL : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String qs1 = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            qs = "";
            qs = qs + " SELECT        DALAppDate, DALAppStatus ";
    ...
    protected void bindDetails()
    {
        ...
        else
        {
            ...
            //Date Approved
            object dt10 = row["DALAppDate"];
            if (dt10 == DBNull.Value)
            {
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        objeto_mail.Subject = "Acknowledged : Request for Acknowledgement for '" + row["Description"].ToString() + "'";

        string htmlText = "<HTML><BODY BGCOLOR=#E1EBF4 STYLE=FONT:TAHOMA,8PT;>"
                            + "Hi " + row["PMName"].ToString() + ",<BR><BR><BR>"

                            + "Your signed proposal for the following opportunity has been <B>ACKNOWLEDGED</B> by DAL person. Kindly proceed to submit this proposal to your client.<BR><BR><BR>"
        ...
        else
        {
            ...
            Response.Redirect("ApprovalSignedProposal_DAL.aspx?Id=" + Request.QueryString["Id"]);
        }
    }
