<%@ Page Language="C#" MasterPageFile="MasterPage.master"  AutoEventWireup="true" CodeFile="Admin_ContractType.aspx.cs" Inherits="PM_Admin_ContractType" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent1" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ChildContent2" Runat="Server">

<div class="panel-heading">Administration - Contract Type</div>
...
<div class="panel-body"> <!--Start Panel Body-->
    ...
    <button type="button" class="btn btn-warning btn-xs input-xxs"  data-toggle="modal" data-target="#myModal" onclick="javascript: return false;" width="150">&nbsp;&nbsp;New Contract Type&nbsp;&nbsp;</button> 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <img src="Img/images2.png"/> <asp:Label ID="lblProject" runat="server" class="control-label input-xxs" Text="New Contract Type" Font-Bold="true"></asp:Label>&nbsp;&nbsp;
                </div>
                <div class="modal-body">
                   ...
                   <br />
                    <div class="row">
                        <div id="dvContract" runat="server">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-4">  
                                 <asp:TextBox ID="fldContractType" runat="server" CssClass="form-control input-xxs" Width="320px" PlaceHolder="(Contract Type)" MaxLength="850"></asp:TextBox> 
                            </div>
                        </div>
                    </div>
                     <br />
    ...
    <asp:GridView ID="gvContract" runat="server" CssClass="table table-bordered table-striped input-xxs" AutoGenerateColumns="false" DataKeyNames="Id" ShowHeaderWhenEmpty="True" Width="50%" onrowediting="EditContractType" onrowupdating="UpdateContractType"  onrowcancelingedit="CancelEdit">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Contract Type" ItemStyle-Width="35%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-VerticalAlign="Top" FooterStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:Label ID="lblContractType" runat="server" Text='<%# Eval("ContractType").ToString() != "" ? Eval("ContractType").ToString() : "-"%>' CssClass="input-xxs"></asp:Label>                    
                    </ItemTemplate>

                    <EditItemTemplate>
                        <asp:TextBox ID="fldContractType" runat="server" Text='<%# Eval("ContractType")%>' Width="250" CssClass="form-control input-xxs"></asp:TextBox>
                    </EditItemTemplate> 

                    <FooterTemplate>   
                        <asp:TextBox ID="fldContractType" runat="server" Width="250" CssClass="form-control input-xxs"></asp:TextBox>
                    </FooterTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField ItemStyle-Width="5%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgDelete" ImageUrl="img/remove.png" runat="server" CommandName ="Delete" CommandArgument = '<%# Eval("ID")%>' OnClientClick = "return confirm('Are you sure you want to remove this Contract Type?')"  OnClick = "DeleteRow"></asp:ImageButton>
                    </ItemTemplate>
                </asp:TemplateField>
