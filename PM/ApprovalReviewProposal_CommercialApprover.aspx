<%@ Page Title="" Language="C#" MasterPageFile="TMS_Email_MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalReviewProposal_CommercialApprover.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ApprovalReviewProposal_CommercialApprover" %>
...
<div class="panel-heading">PROPOSAL EVALUATION / SUBMISSION - COMMERCIAL APPROVAL</div>
<div class="panel-body">
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-3">  
                <asp:DropDownList ID="fldBoardRequired" runat="server" CssClass="form-control input-xxs" Width="150px"></asp:DropDownList>                     
            ...
            <div class="col-md-10"> 
                ...
                <asp:Table ID="tblTechnicalApproval" runat="server" Width="60%" CssClass="table table-bordered input-xxs">
                        ...
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" BackColor="#808080">                        
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" ColumnSpan="2"><asp:Label ID="Label1" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b>Approver</b></asp:Label></asp:TableCell>                           
                        </asp:TableRow>
        ...
        <div id="dvCommercialApproval" runat="server">
            ...
            <div class="col-md-10"> 
                ...
                <asp:Table ID="tblCommercialApproval" runat="server" Width="60%" CssClass="table table-bordered input-xxs" >
                        ...
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" BackColor="#808080">                        
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" ColumnSpan="2"><asp:Label ID="Label3" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b>Approver</b></asp:Label></asp:TableCell>                           
                        </asp:TableRow>
    ...
    <img src="Img/images2.png"/> <asp:Label ID="Label4" runat="server" class="control-label input-xxs" Text="Signed Proposal" Font-Bold="true"></asp:Label>
    ...
    <img src="Img/images2.png"/> <asp:Label ID="Label12" runat="server" class="control-label input-xxs" Text="Commercial Approval Status" Font-Bold="true"></asp:Label>
    ...
    <div class="row">
        <div>
            ...
            <div class="col-md-3">                  
                <asp:Label ID="lblCommercialApprover" runat="server" Text='None' CssClass="input-xxs" ></asp:Label>       
            </div>
        </div>
    </div>
   ...
   <div class="row">
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1" runat="server" class="control-label input-xxs" Font-Italic="true"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Click on <b>Submit</b> button to approve this final proposal.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1a" runat="server" class="control-label input-xxs" Font-Italic="true">&nbsp;&nbsp;&nbsp;&nbsp; When you have approved this final proposal, email notification will be sent to Project Manager to upload signed proposal.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1b" runat="server" class="control-label input-xxs" Font-Italic="true">&nbsp;&nbsp;&nbsp;&nbsp; When you have rejected this final proposal, email notification will be sent to Project Manager for info.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row" align="center">
        <asp:Button ID="btnApprove" runat="server" Text="Approve" CssClass="btn btn-success btn-xs input-xxs" Width="72" OnClientClick="return confirm('Are you sure you want to approve this final proposal?');" OnClick="btnApprove_Click" />
        &nbsp;&nbsp;<asp:Button ID="btnNotApprove" runat="server" Text="Reject" CssClass="btn btn-danger btn-xs input-xxs" Width="60" OnClientClick="return confirm('Are you sure you want to reject this final proposal?');" OnClick="btnNotApprove_Click" />
