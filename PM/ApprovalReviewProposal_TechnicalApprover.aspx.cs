...
public partial class ApprovalReviewProposal_TechnicalApprover : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String qs1 = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            qs = "";
            qs = qs + " SELECT        TechnicalAppDate, TechnicalNotAppDate, TechnicalAppStatus, TechnicalAppComment ";
            ...
            else
            {
                ...
                object dtA = row["TechnicalAppDate"];
                object dtNA = row["TechnicalNotAppDate"];
    ...
    protected void bindDetails()
    {
        ...
        qs = qs + "               StaffLogin.StaffName AS TechnicalApproverName ";
        qs = qs + " FROM          tblProposalEvaluation ";
        ...
        qs = qs + " INNER JOIN    StaffLogin ON tblProposalEvaluation.TechnicalApprover = StaffLogin.StaffNo COLLATE Latin1_General_CI_AI ";
        ...
        else
        {
            ...
            //Approver - Name
            fldTechnicalApprover.Text = row["TechnicalApprover"].ToString();
            lblTechnicalApprover.Text = row["TechnicalApproverName"].ToString();

            //Date Approved
            object dt8 = row["TechnicalAppDate"];
            if (dt8 == DBNull.Value)
            {
            ...
            { lblDtApproved.Text = Convert.ToDateTime(row["TechnicalAppDate"].ToString()).ToString("dd-MMM-yyyy hh:mm:ss tt"); }

            //Date Rejected
            object dt9 = row["TechnicalNotAppDate"];
            if (dt9 == DBNull.Value)
            {
            ...
            { lblDtReject.Text = Convert.ToDateTime(row["TechnicalNotAppDate"].ToString()).ToString("dd-MMM-yyyy hh:mm:ss tt"); }

            //Justification
            fldJustification.Text = row["TechnicalAppComment"].ToString();
            //...................................end of Technical Approval Status...................................
    ...
    protected void btnApprove_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmdR = new SqlCommand("UPDATE tblProposalEvaluation SET "
                + "TechnicalAppStatus = 'Approved', "
                + "TechnicalAppDate = '" + now.ToString("dd-MMM-yyyy hh:mm:ss tt") + "' "
        ...
        qs = qs + "               tblProposalEvaluation.TechnicalProposal, tblProposalEvaluation.ClosingDate, tblProposalEvaluation.ReviewedByDate, ";
        ...
        objeto_mail.Subject = "Approved : Request for Technical Approval for '" + row["Description"].ToString() + "'";

        string htmlText = "<HTML><BODY BGCOLOR=#FFFFE6 STYLE=FONT:TAHOMA,8PT;>"
                            + "Hi " + row["PMName"].ToString() + ",<BR><BR><BR>"

                            + "Your final proposal for the following opportunity has been <B>APPROVED</B> by Technical team. Please get the signature from DAL person and upload the signed proposal into the system.<BR><BR><BR>"
        ...
        Response.Redirect("ApprovalReviewProposal_TechnicalApprover.aspx?Id=" + Request.QueryString["Id"]);
    }
    ...
    protected void btnNotApprove_Click(object sender, EventArgs e)
    {
        ...
        if (chckErr == true)
        {
            ...
            SqlCommand cmdNR = new SqlCommand("UPDATE tblProposalEvaluation SET "
                    + "TechnicalAppStatus = 'Rejected', "
                    + "TechnicalNotAppDate = '" + now.ToString("dd-MMM-yyyy hh:mm:ss tt") + "', "
                    + "TechnicalAppComment = @pJustification "
                    + "WHERE DescriptionId = '" + Request.QueryString["Id"] + "'", con);
            ...
            qs = "";
            qs = qs + " SELECT        tblMain.Id, tblMain.ClientId, tblMain.Description, tblMain.Code, tblMain.ProjectManager, tblMain.OperatingCompany, tblMain.OperatingUnit, tblMain.CreatedBy, ";
            qs = qs + "               tblProposalEvaluation.TechnicalProposal, tblProposalEvaluation.ClosingDate, tblProposalEvaluation.ReviewedByDate, tblProposalEvaluation.TechnicalApprover, tblProposalEvaluation.TechnicalAppComment, ";
            qs = qs + "               tblClient.ClientName AS ClientName, ";
            qs = qs + "               StaffLogin.StaffName AS PMName, StaffLogin.EmailId AS PMEmail, ";
            ...
            objeto_mail.Subject = "Rejected : Request for Technical Approval for '" + row["Description"].ToString() + "'";
            ...
            string htmlText = "<HTML><BODY BGCOLOR=#FFECEC STYLE=FONT:TAHOMA,8PT;>"
                                ...
                                + "<B>Comments : </B>" + row["TechnicalAppComment"].ToString() + "<BR><BR><BR>"
