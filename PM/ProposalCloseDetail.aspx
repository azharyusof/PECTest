<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ProposalCloseDetail.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ProposalCloseDetail" %>
...
<script src="../Scripts/jquery.MultiFile.js" type="text/javascript"></script>
    ...
    <asp:Table ID="tblMenu" runat="server" Width="100%" CssClass="table table-bordered input-xxs" >
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" >                        
                            ...
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblProposalClose" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="ProposalCloseDetail.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">PROPOSAL CLOSE</a></b></asp:Label></asp:TableCell>                            
...
<div id="dvActive" runat="server">
    ...
    <div class="row">
        <div id="dvFeedbackForm" runat="server">
            <div class="col-md-2">
    ...
    <div class="row">        
        <div id="dvDropped" runat="server" visible="false">
            <div class="col-md-2">
                <label class="control-label input-xxs" data-toggle="tooltip" data-placement="right" data-container="body" data-html="true" title="Proposal Drop Remarks" for="fldProposalDropRemarks">Remarks <font color="Red">*</font></label>
            </div>            
            <div class="col-md-3">  
                <asp:TextBox ID="fldProposalDropRemarks" runat="server" CssClass="form-control input-xxs" Width="320px" TextMode="MultiLine" Height="60" PlaceHolder="(Proposal Drop)" MaxLength="850"></asp:TextBox>          
            </div>
        </div>
    </div>
    ...
    <div class="row" align="center">
        ...
        &nbsp;&nbsp;<asp:Button ID="btnDrop" runat="server" Text="Drop Proposal" CssClass="btn btn-warning btn-xs input-xxs" Width="100" OnClick="btnDrop_Click" OnClientClick="return confirm('Are you sure you want to drop this proposal?')" Visible="false"/>
