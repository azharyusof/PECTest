<%@ Page Title="" Language="C#" MasterPageFile="TMS_Email_MasterPage.master" AutoEventWireup="true" CodeFile="ApprovalProjectInitiation.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ApprovalProjectInitiation" %>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="dvApprover" runat="server">
            ...
            <div class="col-md-3">                  
                <asp:Label ID="lblPDApprover" runat="server" CssClass="input-xxs" ></asp:Label>       
            </div>
        </div>
    </div>
   ...
   <div class="row">
    ...
    <div class="row">
        <div>
            <div class="col-md-8">
                <asp:Label ID="lblNote1" runat="server" class="control-label input-xxs" Font-Italic="true"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Click on <b>Approve</b> or <b>Reject</b> button to approve or reject this project.</asp:Label> 
            </div>
        </div>
    </div>
    ...
    <div class="row" align="center">
        <asp:Button ID="btnApprove" runat="server" Text="Approve" CssClass="btn btn-success btn-xs input-xxs" Width="72" OnClientClick="return confirm('Are you sure you want to approve this project initiation request?');" OnClick="btnApprove_Click" />
        &nbsp;&nbsp;<asp:Button ID="btnNotApprove" runat="server" Text="Reject" CssClass="btn btn-danger btn-xs input-xxs" Width="60" OnClientClick="return confirm('Are you sure you want to reject this project initiation request?');" OnClick="btnNotApprove_Click" />
