<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="RegisterProjectDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="RegisterProjectDetailView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ChildContent2" Runat="Server">
    ...
    <asp:Table ID="tblMenu" runat="server" Width="100%" CssClass="table table-bordered input-xxs" >
                        <asp:TableRow runat="server" CssClass="table table-bordered input-sm" >                        
                            ...
                            <asp:TableCell HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#cc3300"><asp:Label ID="lblRegisterNewProject" runat="server" CssClass="input-xxs" ForeColor="#ffffff"><b><a href="RegisterProjectDetailView.aspx?Id=<%= Request.QueryString["Id"] %>" style="color:white">REGISTER NEW PROJECT</a></b></asp:Label></asp:TableCell>                             
...
<div id="dvActive" runat="server">
    ...
    <asp:TemplateField HeaderText="File Name" HeaderStyle-Width="80%" ItemStyle-Width="80%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
        <ItemTemplate>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "http://pectest.uemedgenta.com/PM/Upload/" + Request.QueryString["ID"] + "/SupportingDoc/" + Eval("FileName") + "" %>' Target="_blank"><%# Eval("FileName").ToString()%></asp:HyperLink>            
        </ItemTemplate>
        <EditItemTemplate>
    ...
    <div class="row">
        <div id="dvPreProjectCode" runat="server">
            ...
            <div class="col-md-6">  
                <div class="form-inline">
                    <asp:TextBox ID="fldPreProjectCode" runat="server" CssClass="form-control input-xxs" Width="150px" MaxLength="850" Enabled="false"></asp:TextBox> 
                </div>
            </div>
        </div>
    </div>
