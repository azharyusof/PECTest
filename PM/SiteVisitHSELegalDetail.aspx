<%@ Page Title="" EnableEventValidation="false" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="SiteVisitHSELegalDetail.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="SiteVisitHSELegalDetail" %>
...
<div class="panel-body">
    ...
    <div class="row">
        <div id="dvOPUS" runat="server">
            ...
            <div class="col-md-10"> 
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalF" data-toggle="modal" width="150">&nbsp;&nbsp;New Legal Register Document&nbsp;&nbsp;</button>
                <br />
