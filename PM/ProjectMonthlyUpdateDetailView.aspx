<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ProjectMonthlyUpdateDetailView.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ProjectMonthlyUpdateDetailView" %>
...
<div id="dvActive" runat="server">
        ...
        <div id="dvCode" runat="server">
            ...
            <div class="col-md-3">                
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li ID="tab2" runat="server"><a href='ProjectMonthlyUpdateCostSheetDetailView.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/document_text24.png" /> <asp:Label ID="lblTwo" runat="server" class="control-label input-xxs" Text="COST SHEET"></asp:Label></a></li>
                    <li ID="tab3" runat="server"><a href='ProjectMonthlyUpdateHSERiskDetailView.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/user_half_information24.png" /> <asp:Label ID="lblThree" runat="server" class="control-label input-xxs" Text="RISK"></asp:Label></a></li>
        ...
        <div id="dvProjectDoc" runat="server">
            ...
            <div class="col-md-10"> 
                ...
                <table runat="server" width="100%">
                    <tr>
                    <td align="rileftght">
                        <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalE" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New Project Document&nbsp;&nbsp;</button>
                    </td>
                    <td align="right">
            ...
            <asp:TemplateField HeaderText="File Name" HeaderStyle-Width="30%" ItemStyle-Width="30%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Description" HeaderStyle-Width="30%" ItemStyle-Width="30%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Submit To" HeaderStyle-Width="10%" ItemStyle-Width="10%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
    ...
    <div class="row">
        <div id="dvMonthlyUpdate" runat="server">
            ...
            <div class="col-md-12"> 
                ...
                <button class="btn btn-warning btn-xs input-xxs" onclick="javascript: return false;" data-target="#myModalC" data-toggle="modal" width="150" runat="server" disabled>&nbsp;&nbsp;New Project Status&nbsp;&nbsp;</button>
                <br />

    <asp:GridView ID="gvMonthlyUpdate" runat="server" Width="100%" AutoGenerateColumns="false" PageSize="5" AllowPaging="true"  OnPageIndexChanging="gvMonthlyUpdate_OnPageIndexChanging" CssClass="table table-bordered table-striped input-xxs" >
    <Columns>                
    <asp:TemplateField HeaderText="#" HeaderStyle-Width="5%" ItemStyle-Width="5%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
       <ItemTemplate>
            <asp:Label ID="lblNoUp" runat="server" Text='<%# Container.DataItemIndex + 1 %>' CssClass="input-xxs"></asp:Label>
    ...
    <asp:TemplateField HeaderText="Issues" HeaderStyle-Width="30%" ItemStyle-Width="30%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
        <ItemTemplate>
            <asp:Label ID="lblIssues" runat="server" Text='<%# Eval("Issues")%>' CssClass="input-xxs"></asp:Label>
        </ItemTemplate>
        <EditItemTemplate>
            <asp:TextBox ID="txtIssues" runat="server" Text='<%# Eval("Issues")%>' CssClass="form-control input-xxs" Width="220px" TextMode="MultiLine" Height="60"></asp:TextBox>
        </EditItemTemplate> 
    </asp:TemplateField>
    ...
    <asp:TemplateField HeaderText="Impact" HeaderStyle-Width="5%" ItemStyle-Width="5%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
        ...
        <EditItemTemplate>
            <asp:TextBox ID="txtImpact" runat="server" Text='<%# Eval("Impact")%>' CssClass="form-control input-xxs" Width="180px" TextMode="MultiLine" Height="60"></asp:TextBox>
        </EditItemTemplate> 
    </asp:TemplateField>  
    ...
    <asp:TemplateField HeaderText="Activity Planned for The Month" HeaderStyle-Width="20%" ItemStyle-Width="20%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
        ...
        <EditItemTemplate>
            <asp:TextBox ID="txtActivityPlannedForMonth" runat="server" Text='<%# Eval("ActivityPlannedForMonth")%>' CssClass="form-control input-xxs" Width="180px" TextMode="MultiLine" Height="60"></asp:TextBox>
        </EditItemTemplate> 
    </asp:TemplateField>

    <asp:TemplateField HeaderText="Action to Be Taken" HeaderStyle-Width="10%" ItemStyle-Width="10%" ItemStyle-CssClass="table" HeaderStyle-CssClass="text-center" HeaderStyle-BackColor="#808080" HeaderStyle-ForeColor="White" ItemStyle-HorizontalAlign="Center">
        <ItemTemplate>
        ...
        <EditItemTemplate>
            <asp:TextBox ID="txtActionToBeTaken" runat="server" Text='<%# Eval("ActionToBeTaken")%>' CssClass="form-control input-xxs" Width="180px" TextMode="MultiLine" Height="60"></asp:TextBox>
        </EditItemTemplate> 
    </asp:TemplateField>
        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div id="dvIssues" runat="server">
                    <div class="col-md-3">
                        <label class="control-label input-xxs" data-toggle="tooltip" data-placement="right" data-container="body" data-html="true" title="Issues" for="fldIssues">Issues <font color="Red">*</font></label>
                    </div>            
                    <div class="col-md-4">  
