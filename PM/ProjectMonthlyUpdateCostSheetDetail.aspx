<%@ Page Title="" Language="C#" MasterPageFile="MasterPage.master" AutoEventWireup="true" CodeFile="ProjectMonthlyUpdateCostSheetDetail.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="ProjectMonthlyUpdateCostSheetDetail" %>
        ...
        <div id="dvCode" runat="server">
            ...
            <div class="col-md-3">                
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li ID="tab2" runat="server"><a href='ProjectMonthlyUpdateHSERiskDetail.aspx?Id=<%=Request.QueryString["Id"]%>'><img src="Img/Icon/user_half_information24.png" /> <asp:Label ID="lblTwo" runat="server" class="control-label input-xxs" Text="RISK"></asp:Label></a></li>
