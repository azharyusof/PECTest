...
public partial class ProjectInitiationDetailView : System.Web.UI.Page
{
    DataRow row = null;
    String qs = "";
    String queryString = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            //Disabled Board / Management Paper
            fldA11Upload.Enabled = false;
            btnCancelA11.Enabled = false;
            btnUpA11.Enabled = false;

            //Disabled Service Agreement
            fldA1Upload.Enabled = false;
            btnCancelA1.Enabled = false;
            btnUpA1.Enabled = false;

            btnNewSA.Disabled = true;
            btnNewPEP.Disabled = true;
            btnNewPQP.Disabled = true;
            btnNewPSP.Disabled = true;
            btnNewLR.Disabled = true;
            btnNewHIRARC.Disabled = true;
            btnNewEAI.Disabled = true;
            btnNewHSEP.Disabled = true;
            btnNewPD.Disabled = true;
            btnNewOC.Disabled = true;
            btnNewMS.Disabled = true;
            btnNewRA.Disabled = true;
            btnNewRA.Disabled = true;
